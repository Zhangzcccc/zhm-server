...
CREATE TABLE `zz_dreams` (
    `id` bigint COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
    `user_id` bigint COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户id',
    `original_dream` text COLLATE utf8mb4_general_ci COMMENT '原始梦境',
    `generated_story` text COLLATE utf8mb4_general_ci COMMENT '梦境故事',
    `dream_meaning` text COLLATE utf8mb4_general_ci COMMENT '梦境含义',
    `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除',
    PRIMARY KEY (`id`),
    KEY `zz_dreams_user_id_IDX` (`user_id`) USING BTREE,
    KEY `zz_dreams_created_at_IDX` (`created_at`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户梦境';

-- 故事图片表
CREATE TABLE `zz_dream_images` (
    `id` bigint COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
    `dream_id` bigint COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '梦境id',
    `image_url` text COLLATE utf8mb4_general_ci COMMENT '图片URL',
    `sort_order` int DEFAULT NULL COMMENT '排序',
    `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`),
    KEY `zz_dream_images_dream_id_IDX` (`dream_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='梦境图片';

INSERT INTO ic_agile.sys_menu (id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES(1916696056458686465, 0, '梦境记录', '', '', 0, 'icon-play-square-fill', 4, 1067246875800000001, '2025-04-28 11:28:45', 1067246875800000001, '2025-04-28 11:29:49');
-- 菜单初始SQL
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date)VALUES (1916692670574727170, 1916696056458686465, '用户梦境', 'dream/dreams', NULL, 0, 'icon-desktop', 0, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692670595698689, 1916692670574727170, '查看', NULL, 'dream:dreams:page,dream:dreams:info', 1, NULL, 0, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692670595698690, 1916692670574727170, '新增', NULL, 'dream:dreams:save', 1, NULL, 1, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692670595698691, 1916692670574727170, '修改', NULL, 'dream:dreams:update', 1, NULL, 2, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692670595698692, 1916692670574727170, '删除', NULL, 'dream:dreams:delete', 1, NULL, 3, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692670595698693, 1916692670574727170, '导出', NULL, 'dream:dreams:export', 1, NULL, 4, 1067246875800000001, now(), 1067246875800000001, now());
-- 菜单初始SQL
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date)VALUES (1916692672525078530, 1916696056458686465, '梦境图片', 'dream/dreamimages', NULL, 0, 'icon-desktop', 0, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692672525078531, 1916692672525078530, '查看', NULL, 'dream:dreamimages:page,dream:dreamimages:info', 1, NULL, 0, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692672525078532, 1916692672525078530, '新增', NULL, 'dream:dreamimages:save', 1, NULL, 1, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692672525078533, 1916692672525078530, '修改', NULL, 'dream:dreamimages:update', 1, NULL, 2, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692672525078534, 1916692672525078530, '删除', NULL, 'dream:dreamimages:delete', 1, NULL, 3, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu(id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1916692672525078535, 1916692672525078530, '导出', NULL, 'dream:dreamimages:export', 1, NULL, 4, 1067246875800000001, now(), 1067246875800000001, now());
